...
namespace NeteaseCloudMusicApi {
	public sealed class APIResult
	{
		...
		public static APIResult Success(JObject result)
		{
			return new APIResult { IsSuccess = true, Result = result };
		}
		public static APIResult Failure(JObject result) { return new APIResult { IsSuccess=true, Result = result };}

		public static implicit operator JObject(APIResult result)
		{
